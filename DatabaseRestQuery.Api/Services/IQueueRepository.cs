...
public interface IQueueRepository
{
    ...
    Task MarkCompletedAsync(string transactionId, string message, IReadOnlyList<Dictionary<string, object?>> result, QueryExportInfo? export, CancellationToken cancellationToken);
